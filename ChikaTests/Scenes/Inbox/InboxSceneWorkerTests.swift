...
class InboxSceneWorkerTests: XCTestCase {
    ...
    func testFetchInboxA() {
        ...
        let chatUpdate = ChatRemoteListenerMock()
        let listener = InboxScene.Worker.Listener(recentChat: recentChat, presence: presence, typingStatus: typingStatus, chatUpdate: chatUpdate)
