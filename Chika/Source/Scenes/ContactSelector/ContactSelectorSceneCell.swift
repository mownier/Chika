//
//  ContactSelectorSceneCell.swift
//  Chika
//
...
@objc protocol ContactSelectorSceneCellInteraction: class {
    
    func didTapSelect()
}

protocol ContactSelectorSceneCellAction: class {
    
    func contactSelectorSceneCellWillToggleSelection(_ cell: ContactSelectorSceneCell)
}

class ContactSelectorSceneCell: UITableViewCell {

    weak var action: ContactSelectorSceneCellAction?
    ...
    convenience init() {
        self.init(style: .default, reuseIdentifier: "ContactSelectorSceneCell")
    }
...
extension ContactSelectorSceneCell: ContactSelectorSceneCellInteraction {
    
    func didTapSelect() {
        action?.contactSelectorSceneCellWillToggleSelection(self)
    }
}
